...
NormData Normalize::StandartScoreNorm(const QVector<double>& v)
{
    int n = v.size();
...
QVector<double> Normalize::StandartScoreDeonorm(NormData& norm_data)
{
...
NormData Normalize::MinMaxNorm(const QVector<double>& v)
{
    int n = v.size();
    QVector<double> v_norm(n);
...
QVector<double> Normalize::MinMaxDenorm(NormData& norm_data)
{
    int n = norm_data.v_norm.size();
    QVector<double>::iterator v_norm_b = norm_data.v_norm.begin();
    QVector<double>::iterator v_norm_e = norm_data.v_norm.end();
...
NormData Normalize::DivMaxNorm(const QVector<double>& v)
{
    int n = v.size();
    QVector<double> v_norm(n);
    double v_max;
...
QVector<double> Normalize::DivMaxDenorm(NormData& norm_data)
{
    int n = norm_data.v_norm.size();
    QVector<double>::iterator v_norm_b = norm_data.v_norm.begin();
    QVector<double>::iterator v_norm_e = norm_data.v_norm.end();
